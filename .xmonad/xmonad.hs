...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    , ((modm .|. shiftMask, xK_g), sendMessage $ setGaps [(L,5), (R,5), (U,40), (D,60)]) -- reset the GapSpec
...
myStartupHook = do
  ...
  spawnOnce "exec /home/tronifier/.local/bin/rwall &"
...
defaults = def {
      ...
      -- hooks, layouts
        ...
        layoutHook = gaps [(L,10), (R,10), (U,40), (D,60)] $ spacingRaw True (Border 10 10 10 10) True (Border 10 10 10 10) True $ smartBorders $ myLayout,
